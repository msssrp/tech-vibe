  ...
  const handleOnKeyDown = async (
    ...
    if (e.key === "Enter") {
      ...
      if (trimmedCommentValue !== "") {
        if (!reply) {
          await newComment(article_id, newCommentValue, user_id);
          setNewCommentValue("");
        }
      } else {
        await newComment(article_id, newReply, user_id, commentParentId);
        setNewReply("");
      }
    }
  };
    ...
    <div className="flex items-center">
      ...
      <Drawer opened={opened} onClose={close} position="right" title="Comment">
        {comment && comment.length > 0 ? (
                  ...
                  <div>
                    ...
                    {showInput && replyingTo === parentComment.comment_id && (
                      <input
                        ...
                        onKeyDown={(e) =>
                          handleOnKeyDown(e, true, parentComment.comment_id)
                        }
          ...
          <div className="py-5 px-5 mt-2 w-full focus:outline-blue-100">
            <input
              type="text"
